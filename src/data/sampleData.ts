...
export const SAMPLE_TRANSACTIONS: Transaction[] = [
  ...
  { id: 't6', type: 'expense', amount: 800, currency: 'INR', category: 'food', merchant: 'Starbucks', note: 'Team coffee', date: d(4), tags: ['#coffee'], mood: 'happy', isRecurring: false, taxDeductible: false, createdAt: d(4) },
  ...
  { id: 't10', type: 'expense', amount: 600, currency: 'INR', category: 'entertainment', merchant: 'PVR', note: 'Movie with friends', date: d(7), tags: ['#weekend'], mood: 'happy', isRecurring: false, taxDeductible: false, createdAt: d(7) },
